...
### 6 Active Disturbance Rejection Control of a Quadrotor: A Performance Comparison Study

- **作者/年份:** 不详, 2022
- **来源:** IEEE Access (early access), DOI: 10.1109/ACCESS.2022.3203253
...
### 7 Comparative Analysis of Attitude Control of Quadrotor UAVs: PID, ADRC and LQR

- **作者/年份:** 不详, 2024
- **来源:** IEEE Conference, 2024
- **核心贡献:** 针对四旋翼UAV姿态控制，对比PID、ADRC和LQR三种控制器的跟踪精度与抗扰能力。实验表明PID在简易工况下表现良好，ADRC在强扰动下鲁棒性最优。
- **关键词:** attitude control; PID; ADRC; LQR; quadrotor UAV
- **链接:** https://ieeexplore.ieee.org/abstract/document/10593686 [需手动下载]

### 8 Incremental Nonlinear Dynamic Inversion Control for Quadrotor UAV

- **作者/年份:** 不详, 2023
- **来源:** IEEE Conference, 2023
- **核心贡献:** 将增量式非线性动态逆（INDI）方法应用于四旋翼UAV控制，通过避免对全模型精确建模的需求，实现了对模型不确定性和外部扰动的强鲁棒性。INDI仅依赖于角加速度反馈，计算量低，适合嵌入式实现。
...
- **作者/年份:** 不详, 2023
- **来源:** Annual Reviews in Control, Elsevier
...
- **作者/年份:** 不详, 2018
- **来源:** IFAC-PapersOnLine, Vol. 51, Issue 17, pp. 660-665
...
### 11 Distributionally Robust Kalman Filtering for INS/GPS Tightly Coupled Integration
...
### 13 Analysis of a Robust Kalman Filter in Loosely Coupled GPS/INS Integration
...
### 14 UAV Navigation With Monocular Visual Inertial Odometry in GNSS-Denied Environments
...
### 18 Improving Optical Flow Sensor Using a Gimbal for Quadrotor Stabilization
...
- **作者/年份:** 不详, 2024
- **来源:** ResearchGate / IEEE Conference
